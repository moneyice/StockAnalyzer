...
//n天之内某一天成交量是前一天的  x 倍
public class SuddentHighVolumeLiteAnalyzer extends AbstractStockAnalyzer {

	String descTemplate="在2个工作日内，发生过1次成交量是前一天的4倍";
	...
	double volumeIncrease = 4;

	double[] riseRange = { 0.001, 0.06 };

	public SuddentHighVolumeLiteAnalyzer() {
		setDaysToNow(daysToNow);
		setOccurTimes(occurTimes);
		setVolumeIncrease(volumeIncrease);
	}
